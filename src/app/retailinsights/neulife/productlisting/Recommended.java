...
public class Recommended extends ListActivity {

	ProgressDialog pd;
	private static final String METHOD = "recommended";
	private final String SOAP_ACTION = SessionStorage.webserviceNamespace
			+ "service.php/recommended";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!cd.isConnectingToInternet()) {
			...
			InternetConnection add = new InternetConnection(Recommended.this);
			add.show();
		...
		viewButton1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				gridView.setAdapter(new ProductListingAdapter(Recommended.this,
						alProducts));

				listView.setAdapter(new ProductListingListviewAdapter(
						Recommended.this, alProducts));
								...
								case 0:
									if(tvNoneApplied.getText().toString().equals(""))
									{
										...
										gridView.setAdapter(new ProductListingAdapter(
												Recommended.this, hmProductsOnPrice));
	...
	public void getRecommended() throws JSONException {
		...
		try {
			...
			JSONArray jsonarray = json.getJSONArray("recommended");
			...
			for (int i = 0; i < jsonarray.length(); i++) {
				...
				beanProductListing.setFlavour(object.getString("size"));
	...
	private class AsyncCallWS extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			pd = new ProgressDialog(Recommended.this);
		...
		protected void onPostExecute(Void result) {
			...
			if (alProductListing == null) {
				...
				listView.setAdapter(new ProductListingListviewAdapter(
						Recommended.this, alProductListing));
