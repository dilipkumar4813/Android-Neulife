...
public class Offers extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!cd.isConnectingToInternet()) {
			...
			InternetConnection add = new InternetConnection(Offers.this);
			add.show();
		...
		viewButton1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				gridView.setAdapter(new ProductListingAdapter(Offers.this,
						alProducts));

				listView.setAdapter(new ProductListingListviewAdapter(
						Offers.this, alProducts));
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (listFlag == 1) {
					...
					// "brand selected: "+textValue, Toast.LENGTH_SHORT).show();
	...
	private class AsyncCallWS extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			pd = new ProgressDialog(Offers.this);
