...
public class ProductListing extends ListActivity {
	String[] brand = {  };
	...
	private static final String METHOD = "getProductsBasedOnCategory";
	private final String SOAP_ACTION = SessionStorage.webserviceNamespace
			+ "service.php/getProductsBasedOnCategory";
	GridView gridView;
	TextView tvHeader,tvNoneApplied;
	ImageView backBtn, accountImg, cartImg, wishlistImg, homeImg, searchImg,
			Notifications;
	ListView listView, lvSubCategories, lvSubCategoryDetails;
	LinearLayout ll_filter;
	ImageView gridV;
	TextView tvGrid, productCount;
	RelativeLayout viewButton, rl_filter, viewButton1, rl_cancel, rl_sort,
			rl_filter1;
	int whichView = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!cd.isConnectingToInternet()) {
			...
			InternetConnection add = new InternetConnection(ProductListing.this);
			add.show();
		...
		/*
		 * Toast.makeText(getApplicationContext(), "Category id :" +
		 * SessionStorage.categoryId, Toast.LENGTH_SHORT) .show();
		...
		viewButton1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				gridView.setAdapter(new ProductListingAdapter(
						ProductListing.this, alProducts));
				...
				builder.setSingleChoiceItems(items, -1,
						...
						case 0:
							if(tvNoneApplied.getText().toString().equals(""))
							{
								...
								gridView.setAdapter(new ProductListingAdapter(
										ProductListing.this, hmProductsOnPrice));
		...
		rl_filter.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				/*
				 * db = new DatabaseHandler(getApplicationContext()); brand =
				 * db.getBrandNames(); setListAdapter(new ArrayAdapter<String>(
				 * getApplicationContext(),
				 * android.R.layout.simple_list_item_checked, brand));
				 */
			}
	...
	public void initialize() {
		...
		tvHeader.setText(SessionStorage.headerTitle);
	...
	public void basicEvents() {
		...
		Notifications.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Toast.makeText(ProductListing.this, "Notification History",
	...
	public void getProductsBasedOnCategory() throws JSONException {
		...
		request.addProperty("productid", SessionStorage.categoryId);
		request.addProperty("customerType", SessionStorage.customerType);
		
		// request.addProperty("productid", "60");
		Log.w("SessionStorage.categoryId  ", "" + SessionStorage.categoryId);
		...
		try {
			...
			JSONArray jsonarray = json.getJSONArray("ProductByCategory");
	...
	private class AsyncCallWS extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			pd = new ProgressDialog(ProductListing.this);
		...
		protected void onPostExecute(Void result) {
			...
			if (alProductListing == null) {
				...
				gridView.setAdapter(new ProductListingAdapter(
						ProductListing.this, alProductListing));
