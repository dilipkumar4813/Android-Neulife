...
public class BestSellers extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!cd.isConnectingToInternet()) {
			...
			InternetConnection add = new InternetConnection(BestSellers.this);
			add.show();
		...
		viewButton1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				gridView.setAdapter(new ProductListingAdapter(BestSellers.this,
						alProducts));

				listView.setAdapter(new ProductListingListviewAdapter(
						BestSellers.this, alProducts));
						...
						case 0:
							if(tvNoneApplied.getText().toString().equals(""))
							{
								...
								gridView.setAdapter(new ProductListingAdapter(
										BestSellers.this, hmProductsOnPrice));
	...
	public void getBestSellers() throws JSONException {
		...
		try {
			...
			JSONArray jsonarray = json.getJSONArray("bestsellers");
	...
	private class AsyncCallWS extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			pd = new ProgressDialog(BestSellers.this);
		...
		protected void onPostExecute(Void result) {
			...
			if (alProductListing == null) {
				...
				listView.setAdapter(new ProductListingListviewAdapter(
						BestSellers.this, alProductListing));
